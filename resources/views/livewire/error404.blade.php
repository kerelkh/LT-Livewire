<div class="px-2 md:px-5 lg:px-10 py-5 flex justify-center items-center h-full">
    <div class="max-w-[50rem] flex flex-col mx-auto size-full">
        <!-- ========== HEADER ========== -->
        <header class="mb-auto flex justify-center z-50 w-full py-4">
          <nav class="px-4 sm:px-6 lg:px-8">
            <a class="flex-none text-xl font-semibold sm:text-3xl dark:text-white" href="#" aria-label="Brand">{{ config('app.name') }}</a>
          </nav>
        </header>
        <!-- ========== END HEADER ========== -->
