<div class="px-2 md:px-5 lg:px-10 py-5">
    ...
    <div class="max-w-[85rem] mx-auto px-4 sm:px-6 lg:px-8">
        <a wire:navigate href="{{ route('posts.show') }}" class="text-blue-600 hover:text-blue-500 decoration-2 hover:underline focus:outline-none focus:underline opacity-90">
